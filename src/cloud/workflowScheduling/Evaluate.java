...
public class Evaluate {
	...
	private static final int FILE_INDEX_MAX = 2;//5;
	private static final int[] SIZES = { 50, 100};//, 500};		//50, 100, 500 task num of workflow
	...
	private static final Scheduler[] METHODS = {new LACO()};//new ICPCP(), new PSO(), new ProLiS(1.5),new LACO() };
	...
	static final String WORKFLOW_LOCATION = "E:\\0Work\\workspace-notUTF-8\\L-ACO-paper\\L-ACO-paper\\workflowSamples";
	static final String OUTPUT_LOCATION = "E:\\0Work\\workspace-notUTF-8\\L-ACO-paper\\L-ACO-paper\\result";
